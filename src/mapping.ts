...
export function handleEventLog1MantleSepolia(event: EventLog1): void {
  handleEventLog1(event, "mantle-sepolia");
}

export function handleEventLog2MantleSepolia(event: EventLog2): void {
  handleEventLog2(event, "mantle-sepolia");
}
